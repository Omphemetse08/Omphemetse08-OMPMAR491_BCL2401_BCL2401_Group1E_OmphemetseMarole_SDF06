...
In this project, i managed to creat a simple version of codespace pet instagram profile page doing everything on css and styling.

### Reflections

#### Areas of Mastery

- **CSS Layout Techniques**: I feel so down in using Flexbox and Grid to structure web page elements because i was bit confused. Implementing these techniques to align and distribute content was a highlight of my learning.
